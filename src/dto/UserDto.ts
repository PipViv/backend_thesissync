class UserDto {
    ...
    constructor(id:number,cedula: string, nombre: string, apellido: string, correo: string,
        carrera: number, celular: string, //username: string, 
        //passwd: string,
        //rol: number
        ) {
        this.id = id
   ...
   // }
    ...
    public toString(): string {
        return `Usuario: {id: ${this.id}, cedula: ${this.cedula}, nombre: ${this.nombre}, apellido: ${this.apellido}, correo: ${this.correo}, carrera: ${this.carrera}, celular: ${this.celular}}`;
    }
}
